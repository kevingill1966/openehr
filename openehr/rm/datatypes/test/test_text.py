...
class DvParagraphTest(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        uri = None  # TODO
        txt1 = DvText( "Some really interesting text line 1.",[tm,],"font-family:Arial",uri,cplang,cpenc)
        txt2 = DvText("Some really interesting text line 2.",[tm,],"font-family:Arial",uri,cplang,cpenc)
        txt3 = DvText("Some really interesting text line 3.",[tm,],"font-family:Arial",uri,cplang,cpenc)
        txt4 = DvText("Some really interesting text line 4.",[tm,],"font-family:Arial",uri,cplang,cpenc)
